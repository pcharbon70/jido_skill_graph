defmodule Jido.Skillset.JidoAdapter do
  @moduledoc """
  Optional integration helpers for wiring Jido.Skillset into Jido runtimes.
  ...
  def child_spec(opts \\ []) do
    ...
    child = {Jido.Skillset, graph_opts}
  ...
  def read_node_body(graph_id, node_id, opts \\ []) do
    ...
    Jido.Skillset.read_node_body(graph_id, node_id, opts)
  end
end
