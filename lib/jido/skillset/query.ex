defmodule Jido.Skillset.Query do
  @moduledoc """
  Query operations over immutable `Jido.Skillset.Snapshot` structs.
  """

  alias Jido.Skillset.{Edge, SearchBackend, SkillFile, Snapshot, Telemetry}
  alias Jido.Skillset.SearchBackend.Indexed, as: IndexedSearch
